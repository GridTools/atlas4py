...
def test_mpi_comm():
    ...
    assert atlas4py.mpi.Comm("world") == atlas4py.mpi.Comm.WORLD
    assert atlas4py.mpi.Comm("self") == atlas4py.mpi.Comm.SELF
...
def test_mpi_repr_and_str():
    WORLD = atlas4py.mpi.Comm.WORLD
    assert repr(atlas4py.mpi.Comm("world")) == "atlas4py.mpi.Comm(" + str(int(WORLD)) + ")"
    assert eval(repr(atlas4py.mpi.Comm("world"))) == WORLD
    assert str(atlas4py.mpi.Comm("world")) == "atlas4py.mpi.Comm(name=world, size=" + str(WORLD.size) + ", rank=" + str(WORLD.rank) + ", int=" + str(int(WORLD)) + ")"
...
def test_mpi_scope():
    mpi = atlas4py.mpi
    comm_scope_1 = mpi.register_comm("scope 1", atlas4py.mpi.Comm.WORLD)
    comm_scope_2 = mpi.register_comm("scope 2", atlas4py.mpi.Comm.SELF)
...
def test_scope_repr_and_str():
    scope = atlas4py.mpi.Scope("world")
    assert repr(scope) == "atlas4py.mpi.Scope(name=world)"
    assert str(scope) == "atlas4py.mpi.Scope(name=world)"
